...
public class IShop {
	...
	private void initialize() {
	    ...
	    frame.setTitle("SHOP Simulator - Charuni");
	...
	public ArrayList<Customer.RoadLbl> getStartingRoads() {
		ArrayList<Customer.RoadLbl> roads = new ArrayList<Customer.RoadLbl>();
		
		if (cbAIn.isSelected()) {
			roads.add(Customer.RoadLbl.a);
		}
		if (cbBIn.isSelected()) {
			roads.add(Customer.RoadLbl.b);
		}
		if (cbCIn.isSelected()) {
			roads.add(Customer.RoadLbl.c);
		}
		if (cbDIn.isSelected()) {
			roads.add(Customer.RoadLbl.d);
		}
		
		return roads;
	}
	
	public ArrayList<Customer.RoadLbl> getEndingRoads() {
		ArrayList<Customer.RoadLbl> roads = new ArrayList<Customer.RoadLbl>();
