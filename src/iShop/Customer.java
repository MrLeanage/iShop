...
public class Customer extends Observable implements Runnable{
	...
	//test case 2
	public Customer(RoadLbl destination) {
	...
	private void randomiseAttributes(){
		...
		case 1:
			colour = Colour.blue;
			try {
				image = ImageIO.read(new File("src/iShop/images/blue_Customer.png"));
			} catch (IOException e) {
		...
		case 2:
			colour = Colour.green;
			try {
				image = ImageIO.read(new File("src/iShop/images/green_Customer.png"));
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case 3:
			colour = Colour.red;
			try {
				image = ImageIO.read(new File("src/iShop/images/red_Customer.png"));
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case 4:
			...
			try {
				image = ImageIO.read(new File("src/iShop/images/yellow_Customer.png"));
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		//fetches roads that the Customer can use
